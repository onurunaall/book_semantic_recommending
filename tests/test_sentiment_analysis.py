...
def test_calculate_max_emotion_scores():
    ...
    expected = {
        "anger": 0.2, "disgust": 0.3, "fear": 0.4, "joy": 0.5,
        "sadness": 0.6, "surprise": 0.7, "neutral": 0.8,
    }
...
class DummyClassifier:
    """
    Dummy classifier that returns, for each sentence, the same list of
    emotion scores.
    """
...
def test_process_books_batch_and_max_scores():
    ...
    assert list(emotions_df.columns) == expected_cols
